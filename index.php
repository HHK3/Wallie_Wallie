...
<div id="id01" class="modal1">
    <form class="modal-content animate" id="register" action="verwerk_registratie.php" method="post">
        ...
        <div class="container">
            ...
            <input type="text" placeholder="Gebruikersnaam" name="username" required autofocus>
            <br><br>
            <label for="mail"><b>Email</b></label>
            <input type="email" placeholder="Email" name="mail" required>
            <br><br>
            <label for="password1"><b>Wachtwoord</b></label>
            <input type="password" placeholder="Wachtwoord" name="password1" required>
            <br><br>
...
<div id="id02" class="modal2">
    ...
    <form class="modal-content animate" id="login" action="verwerk_inloggen.php" method="post">
        ...
        <div class="container">
            ...
            <hr>
            <br>
            <label for="username_log"><b>Gebruikersnaam</b></label>
            <input type="text" placeholder="Voer hier uw gebruikersnaam in" name="username_log" required>
            <br><br>
...
<?php
    ...
    if (strpos($fullUrl, "login=error") == true) {
        echo '<p class="error">Ongeldige username/wachtwoord combo. Probeer het opnieuw.</p>
                <button onclick="document.getElementById(\'id04\').style.display=\'block\'" style="width:auto;">Wachtwoord vergeten?</button>
                ...
                <div id="id04" class="modal4">
                     <form class="modal-content animate" action="verwerk_ww.php" method="post">
                        ...
                        <div class="container">
                            ...
                            <input type="email" placeholder="Voer hier uw Email in" name="email" required>
        ...
        echo '<p class="succes">Je account is aangemaakt! Ga naar je E-mail om je account te bevestigen.</p>';
    }  else if (strpos($fullUrl, "password_reset=success") == true) {
        echo '<p class="succes">Er een mail naar je Email verstuurd. Bekijk het om je wachtwoord te zien.</p>';
    }  else if (strpos($fullUrl, "password_reset=error") == true) {
        echo '<p class="error">Er bestaat geen account met het ingetypte Email. Probeer het opnieuw.</p>
                <button onclick="document.getElementById(\'id04\').style.display=\'block\'" style="width:auto;">Wachtwoord vergeten?</button>
                ...
                <div id="id04" class="modal4">
                     <form class="modal-content animate" action="verwerk_ww.php" method="post">
                        ...
                        <div class="container">
                            <h1>Wachtwoord vergeten?</h1>
                            <p class="text">Vul je Email in en je ontvangt per Email je regeistreerde wachtwoord.</p>
                            <hr>
                            <br>
                            <label for="email"><b>Email</b></label>
                            <input type="email" placeholder="Voer hier uw Email in" name="email" required>
        ...
        echo '<p class="succes">Het verifieren van jouw account is gelukt! Je kan nu inloggen!</p>';
        ...
        echo '<p class="succes">Je hebt je wachtwoord met succes gewijzigd!</p>';
    }
?>
